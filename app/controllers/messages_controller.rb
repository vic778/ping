class MessagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @message.save
        format.turbo_stream do 
          render turbo_stream: [
            #here i'm creating a new message without rendering the view
            turbo_stream.update('new_message', partial: "messages/form", locals: {message: Message.new}),
            #here i'm displayig the new message after it was created
    ...
    respond_to do |format|
      format.turbo_stream do
         render turbo_stream: [
          ...
          turbo_stream.update('message_counter', html: Message.count),
          turbo_stream.update('notice', html: "Message was successfully destroyed.")
         ]
      end
  ...
  #get the local time of the first sent request and the local time of when the server response was received
